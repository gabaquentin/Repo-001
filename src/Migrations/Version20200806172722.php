 ...
 */
final class Version20200806172722 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, info_user_id INT DEFAULT NULL, extra_info_id INT DEFAULT NULL, telephone INT DEFAULT NULL, departement VARCHAR(255) DEFAULT NULL, type_partenaire VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B325ABFA0B (info_user_id), UNIQUE INDEX UNIQ_1D1C63B38550C61A (extra_info_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
