 ...
 */
final class Version20200814191417 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, client_id INT DEFAULT NULL, note DOUBLE PRECISION NOT NULL, commentaire LONGTEXT DEFAULT NULL, date_publication DATETIME NOT NULL, INDEX IDX_8F91ABF0F347EFB (produit_id), INDEX IDX_8F91ABF019EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE categorie_prod (id INT AUTO_INCREMENT NOT NULL, categorie_parent_id INT DEFAULT NULL, nom_categorie VARCHAR(255) NOT NULL, type_categorie VARCHAR(255) DEFAULT NULL, quantite INT DEFAULT NULL, ordre INT NOT NULL, INDEX IDX_C29D96C0DF25C577 (categorie_parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie_service (id INT AUTO_INCREMENT NOT NULL, categorie_parent INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, img VARCHAR(255) NOT NULL, INDEX fk_categorie_service (categorie_parent), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commandes (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, livreur_id INT DEFAULT NULL, info_livraison_id INT DEFAULT NULL, date_com DATETIME NOT NULL, date_livraison DATETIME DEFAULT NULL, mode_paiement VARCHAR(255) NOT NULL, panier LONGTEXT NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_35D4282C19EB6921 (client_id), INDEX IDX_35D4282CF8646701 (livreur_id), INDEX IDX_35D4282CA3892C82 (info_livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dimension (id INT AUTO_INCREMENT NOT NULL, longueur DOUBLE PRECISION DEFAULT NULL, largeur DOUBLE PRECISION DEFAULT NULL, hauteur DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, caracteristique_id INT DEFAULT NULL, dimension_id INT DEFAULT NULL, date_id INT DEFAULT NULL, client_id INT DEFAULT NULL, ville_id INT DEFAULT NULL, categorie_prod_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, type_transaction VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, prix_promo DOUBLE PRECISION NOT NULL, images VARCHAR(255) NOT NULL, localisation VARCHAR(255) DEFAULT NULL, visiblite TINYINT(1) NOT NULL, priorite DOUBLE PRECISION NOT NULL, duree_sejour INT DEFAULT NULL, meuble TINYINT(1) DEFAULT NULL, produits_associes VARCHAR(255) DEFAULT NULL, attributs LONGTEXT DEFAULT NULL, nbre_consultations INT NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_29A5EC271704EEB7 (caracteristique_id), UNIQUE INDEX UNIQ_29A5EC27277428AD (dimension_id), UNIQUE INDEX UNIQ_29A5EC27B897366B (date_id), INDEX IDX_29A5EC2719EB6921 (client_id), INDEX IDX_29A5EC27A73F0036 (ville_id), INDEX IDX_29A5EC275E4B91D7 (categorie_prod_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, info_user_id INT DEFAULT NULL, extra_info_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, departement VARCHAR(255) DEFAULT NULL, partenariat VARCHAR(255) DEFAULT NULL, last_login VARCHAR(255) DEFAULT NULL, local VARCHAR(255) NOT NULL, creation VARCHAR(255) NOT NULL, image LONGBLOB NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D64925ABFA0B (info_user_id), UNIQUE INDEX UNIQ_8D93D6498550C61A (extra_info_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
